...
import { ThemeViewer } from '@/components/Theming/ThemeViewer';
...
import { IconButtonExample, ButtonThemeExample, ColorThemes, Matrix } from './examples';
...
```tsx file=./examples/ColorThemes.tsx
...
<ThemeViewer variation="outlined" />
<ThemeViewer variation="primary" />
<ThemeViewer variation="link" />
